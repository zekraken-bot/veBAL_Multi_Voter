...
export default function App() {
  ...
  async function updateVotes() {
    ...
    await erc20.vote_for_many_gauge_weights(
      [
        gauge1.address.slice(2, 42),
        gauge2.address.slice(2, 42),
        gauge3.address.slice(2, 42),
        gauge4.address.slice(2, 42),
        gauge5.address.slice(2, 42),
        gauge6.address.slice(2, 42),
        gauge7.address.slice(2, 42),
        gauge8.address.slice(2, 42),
      ],
